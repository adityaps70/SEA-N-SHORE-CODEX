  ...
  if (comment.deleted) {
    ...
    return (
      <div id={`comment-${comment.id}`} className="flex gap-2.5" data-testid="visible-top-level-comment">
        <div className="min-w-0 flex-1 rounded-2xl bg-mist-50 px-3 py-3">
      ...
      <div className="min-w-0 flex-1">
        <div className="relative rounded-2xl bg-mist-50 px-3 py-2.5">
          <div className="flex flex-wrap items-baseline gap-x-2 pr-7">
            ...
            <div className="ml-auto inline-flex items-center gap-1 text-[11px] text-muted">
          ...
          {!readOnly && comment.viewerOwns ? (
            <div className="absolute right-1.5 top-1.5">
              <button
                ...
                className="grid size-7 place-items-center rounded-full text-muted transition hover:bg-white hover:text-navy-950"
              >
              ...
              {menuOpen ? (
                <div className="absolute right-0 z-20 mt-1 min-w-24 overflow-hidden rounded-xl border border-mist-100 bg-white py-1 shadow-lg">
                  {comment.canEdit ? (
                    <button type="button" onClick={beginEdit} className="block w-full px-3 py-2 text-left text-xs font-semibold text-navy-950 hover:bg-mist-50">Edit</button>
                  ) : null}
          ...
          {editing ? (
            ...
            >
              ...
              <MentionInput
                ...
                className="min-h-16 w-full resize-y rounded-xl border border-mist-100 bg-white px-3 py-2 text-sm text-ink outline-none placeholder:text-muted focus:border-ocean-500"
              />
