...
export function ProfileEditForm({ profile }: { profile: OwnProfile }) {
  ...
  const sectionClass = 'scroll-mt-24 rounded-2xl border border-mist-100 bg-mist-50/40 p-4 sm:p-5'
  ...
  return (
    <Card className="border border-mist-100 p-5 sm:p-6">
      <form key={state.revision ?? 0} action={formAction} className="space-y-6">
        ...
        <section id="identity" className={sectionClass}>
          <div className="mb-4">
            <p className="text-xs font-semibold uppercase tracking-[.14em] text-ocean-700">Basic information</p>
            <h2 className="mt-1 text-lg font-semibold text-navy-950">Name and professional headline</h2>
          </div>
        ...
        <section id="about" className={sectionClass}>
          <div className="mb-4">
            <p className="text-xs font-semibold uppercase tracking-[.14em] text-ocean-700">About</p>
            <h2 className="mt-1 text-lg font-semibold text-navy-950">Summary and expertise</h2>
          </div>
          <label className={labelClass}>
            About
        ...
        <section className={sectionClass}>
          <p className="text-xs font-semibold uppercase tracking-[.14em] text-ocean-700">Privacy</p>
        ...
        {isMaritime ? (
          <fieldset id="professional" className={`${sectionClass} scroll-mt-24`}>
            <legend className="px-1 text-sm font-semibold text-navy-950">Professional record</legend>
