...
describe('/admin/learning/analytics', () => {
  ...
  it('shows aggregate platform learning outcomes and course performance', async () => {
    ...
    expect(screen.getByText('Active mentors').closest('article')).toHaveTextContent('4')
    expect(screen.getByText('Enrollments').closest('article')).toHaveTextContent('10')
    expect(screen.getByText('Completion rate').closest('article')).toHaveTextContent('40%')
    expect(screen.getByText('Average progress').closest('article')).toHaveTextContent('61%')
    expect(screen.getByText('Certificates issued').closest('article')).toHaveTextContent('3')
    expect(screen.getByText('Assignments awaiting review').closest('article')).toHaveTextContent('2')
    expect(screen.getByText('Needs revision').closest('article')).toHaveTextContent('1')
