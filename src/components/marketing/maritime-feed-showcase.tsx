  ...
  return (
    <section className="py-16 sm:py-20" aria-labelledby="feed-showcase-title">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
        <LandingSectionHeading eyebrow="Professional feed" title="Professional conversations built around the work" body="Sea N Shore gives maritime professionals a place to exchange practical knowledge, ask better questions and keep useful experience circulating across the industry." />
