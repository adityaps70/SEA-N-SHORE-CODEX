  ...
  return (
    <section className="border-y border-mist-100 bg-white py-16 sm:py-20" aria-labelledby="ecosystem-journey-title">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
        <LandingSectionHeading eyebrow="One connected journey" title="Connect. Learn. Share. Grow." body="Sea N Shore is designed so your identity, network and knowledge reinforce each other throughout a maritime career." align="center" />
