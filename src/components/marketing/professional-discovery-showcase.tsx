  ...
  return (
    <section className="border-y border-mist-100 bg-white py-16 sm:py-20" aria-labelledby="professional-discovery-title">
      <div className="mx-auto grid w-full max-w-7xl gap-9 px-4 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
        <LandingSectionHeading id="professional-discovery-title" eyebrow="Professional discovery" title="Find the people you need across maritime" body="Sea N Shore is designed around maritime roles and professional context, so discovery starts with the language the industry already uses." />
