    ...
    <header className="hidden border-b border-mist-100 bg-white md:block">
      <div className="mx-auto flex min-h-18 w-full max-w-7xl items-center gap-6 px-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link href="/profile" className="inline-flex min-h-10 items-center gap-1.5 rounded-lg px-2 text-sm font-semibold text-navy-900 hover:bg-mist-50">
            <UserRound aria-hidden="true" className="size-4" />
            Profile
          </Link>
          <form action={signOut}>
            <button type="submit" aria-label="Sign out" className="grid min-h-10 min-w-10 place-items-center rounded-lg text-muted hover:bg-mist-50 hover:text-navy-900">
