...
const allowedPhases = new Set(['confirm', 'grant-admin', 'resolve-application', 'verify-approval', 'resolve-job', 'probe-job', 'verify-republish', 'verify-job-application', 'verify-unauthorized', 'cleanup'])
