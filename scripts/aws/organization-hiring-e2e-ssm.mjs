...
const allowedPhases = new Set(['confirm', 'grant-admin', 'resolve-application', 'verify-approval', 'resolve-job', 'probe-job', 'verify-job-application', 'verify-unauthorized', 'cleanup'])
