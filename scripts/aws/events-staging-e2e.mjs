...
async function createEvent() {
  ...
  await page.goto(`${siteUrl}/events/create`, { waitUntil: 'networkidle' })
...
async function attendeeRsvp() {
  ...
  await page.goto(`${siteUrl}/events/${eventId}`, { waitUntil: 'networkidle' })
  await expect(page.getByRole('heading', { name: eventTitle })).toBeVisible()
  ...
  await page.goto(`${siteUrl}/events/my`, { waitUntil: 'networkidle' })
  await expect(page.getByText(eventTitle, { exact: true })).toBeVisible()
  await page.goto(`${siteUrl}/events/${eventId}/edit`, { waitUntil: 'networkidle' })
